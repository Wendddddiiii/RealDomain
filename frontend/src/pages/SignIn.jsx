  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className='flex flex-col gap-4'onSubmit={handleSubmit}>
        ...
        <button disabled={loading} className="bg-amber-300 text-white p-3 rounded-lg uppercase hover:opacity-70 disabled:opacity-60">{loading ? 'Loading...': 'Sign In'}</button>
      </form>
      <div className='flex gap-2 mt-5'>
        <p>Do not have an account?</p>
        <Link to={"/sign-up"}>
          <span className='text-yellow-800'>Sign up</span>
        </Link>
      </div>
