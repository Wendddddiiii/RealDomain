...
export default function CreateListing() {
    ...
    return (
        <main className="p-3 max-4-xl mx-auto">
            <h1 className='text-3xl font-semibold text-center my-7 text-yellow-800'>Create a Listing</h1>
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-5'>
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button disabled={loading || uploading} className="p-3 bg-yellow-400 text-white rounded-lg hover:opacity-80 disabled:opacity-60">{loading ? 'Creating...': 'Create Listing'}</button>
